...
function CardItem({ image, title, description }) {
  return (
    <div className="min-w-[200px] max-w-[100%] md:max-w-[230px] min-h-[200px] max-h-[200px] p-3 py-4 hover:text-second-100  border-2 border-[#ccccccbc]  duration-300 hover:border-pc-200 rounded-md">
